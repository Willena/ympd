...
Lang.prototype.evaluateLang = function () {
    ...
    $("[data-lang]").each(function () {
        console.log(this.dataset['lang'], that.getTranslation(this.dataset['lang']));
        if (this.tagName && this.tagName.toLowerCase() == "input")
            this.setAttribute("placeholder",that.getTranslation(this.dataset['lang']) );
        else
            this.innerHTML = that.getTranslation(this.dataset['lang']);
    });
};
